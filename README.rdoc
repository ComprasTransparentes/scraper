...
### Documentación de Scraper

## API en Rails que escribe los datos 
...
* Es posible parametrizar la fecha de inicio del scraper de Licitaciones, editando la línea 932 del archivo.
